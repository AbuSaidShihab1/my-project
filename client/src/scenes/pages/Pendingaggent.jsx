  ...
  return (
   <>
     <Box display={isNonMobile ? "flex" : "block"} sx={{display:"flex",justifyContent:'space-between'}} width="100%" height="100%">
      ...
      {/* ------------------------agent information------------------- */}
      {
        pending_agent.length > 0 ?     <section className="p-[20px] ">
                ...
                <td className="px-4 py-4 text-sm whitespace-nowrap">
                  <div className="flex items-center gap-x-2">
                    <NavLink to={`/agent-details/${data._id}`}>
                       <button className="transition-colors duration-200 p-[12px] rounded-[5px] bg-[#6A3FFF] text-[23px] text-white dark:hover:text-white dark:text-gray-300 hover:text-indigo-500 focus:outline-none">
                      <FaRegEye/>
                    </button>
                    </NavLink>
