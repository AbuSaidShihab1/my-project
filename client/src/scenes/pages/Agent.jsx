     ...
     <Box display={isNonMobile ? "flex" : "block"} sx={{display:"flex",justifyContent:'space-between'}} width="100%" height="100%">
      ...
      {/* ------------------------agent information------------------- */}
      {
        agent_information.length > 0 ?     <section className="p-[20px]">
               ...
               <section className="grid grid-cols-4 mt-[20px] gap-[20px]">
                <div className="bg-[#D1E7DD] rounded-[5px]  p-[20px]">
                    <div className="flex justify-start gap-[20px]">
                        <div className="w-[60px] h-[60px] rounded-[5px] flex justify-center items-center bg-[#198754] text-[22px] text-white">
                          <FaUserAlt/>
                        </div>
                       <div>
                         <h1 className="text-[16px] font-[600] text-[#313b5e]">All Agents</h1>
                         <h2 className="text-[20px] mt-[5px] text-[#5d7186] font-[600] ">+{agent_information.length}</h2>
                       </div>
                    </div>
                </div>
                    <div className="bg-[#FFF3CD] rounded-[5px]  p-[20px]">
                    <div className="flex justify-start gap-[20px]">
                        <div className="w-[60px] h-[60px] rounded-[5px] flex justify-center items-center bg-[#FFC107] text-[22px] text-white">
                          <FaUserAlt/>
                        </div>
                       <div>
                         <h1 className="text-[16px] font-[600] text-[#313b5e]">Approved Agents</h1>
                         <h2 className="text-[20px] mt-[5px] text-[#5d7186] font-[600] ">+{agent_information.length}</h2>
                       </div>
                    </div>
                </div>
                    <div className="bg-[#CFF4FC] rounded-[5px]  p-[20px]">
                    <div className="flex justify-start gap-[20px]">
                        <div className="w-[60px] h-[60px] rounded-[5px] flex justify-center items-center bg-[#0DCAF0] text-[22px] text-white">
                          <FaUserAlt/>
                        </div>
                       <div>
                         <h1 className="text-[16px] font-[600] text-[#313b5e]">Pending Agents</h1>
                         <h2 className="text-[20px] mt-[5px] text-[#5d7186] font-[600] ">+{agent_information.length}</h2>
                       </div>
                    </div>
                </div>
                    <div className="bg-[#F8D7DA] rounded-[5px]  p-[20px]">
                    <div className="flex justify-start gap-[20px]">
                        <div className="w-[60px] h-[60px] rounded-[5px] flex justify-center items-center bg-[#DC3545] text-[22px] text-white">
                          <FaUserAlt/>
                        </div>
                       <div>
                         <h1 className="text-[16px] font-[600] text-[#313b5e]">Canceled Agents</h1>
                         <h2 className="text-[20px] mt-[5px] text-[#5d7186] font-[600] ">+{agent_information.length}</h2>
                       </div>
                    </div>
                </div>
  ...
  <div className="flex flex-col">
    <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 px-[15px]">
      <div className="inline-block min-w-full py-2 align-middle">
       ...
       {
                                 agent_information.length >0 ? agent_information.filter((item)=>{
                                    if(find_agent==""){
                                        return item;
                                    }else if(item.name.toLowerCase().includes(find_agent.toLocaleLowerCase()) || item.phone.toLowerCase().includes(find_agent.toLocaleLowerCase())){
                                               return item;
                                    }
                                 }).map((data,index)=>{
            return(
     <tr>
                <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                  ...
                  <div className="flex items-center gap-x-2">
                    <img className="object-cover w-8 h-8 rounded-full" src="https://www.aiscribbles.com/img/variant/large-preview/9570/?v=5528a6" alt />
                    <div>
                      <h2 className="text-sm font-medium text-gray-800 dark:text-white ">{data.name}</h2>
                      <p className="text-xs font-normal text-gray-600 dark:text-gray-400">{data.phone}</p>
                    </div>
                  </div>
                </td>
                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                    {
                        data.status=="deactivated" ?  <div className="inline-flex items-center px-3 py-1 text-red-500 rounded-full gap-x-2 bg-red-100/60 dark:bg-gray-800">
                ...
                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">$0</td>
                <td className="px-4 py-4 text-sm whitespace-nowrap">
                  <div className="flex items-center gap-x-6">
                    ...
                    <button onClick={()=>{delete_agent(data._id)}} className="p-[12px] transition-colors duration-200 rounded-[5px]  bg-[#eb3b5a] text-[23px] text-white hover:text-indigo-500 focus:outline-none">
                      <MdOutlineDelete/>
                    </button>
                  </div>
                </td>
