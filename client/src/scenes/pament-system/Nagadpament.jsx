...
const Nagadpament = () => {
    ...
    const bkash_pament= async(e)=>{
        e.preventDefault();
        const {data}=await axios.post("http://localhost:6001/api/payment/nagad",{mid:"merchant1",orderId:"4532521213131231dadfdsd23123",ip:"312313",payerId:"313rdwr13dasd1231ad23",amount:56660,currency:"BDT",redirectUrl:"https://admin.eassypay.com/bkash_api",callbackUrl:"https://admin.eassypay.com/bkash_api"},{ withCredentials: true },{
              headers: {
