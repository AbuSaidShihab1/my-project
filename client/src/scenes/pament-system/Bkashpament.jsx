...
const Bkashpament = () => {
    ...
    const bkash_pament= async(e)=>{
        e.preventDefault();
        const {data}=await axios.post("http://localhost:6001/api/payment/bkash",{mid:"merchant1",orderId:"34234234234",payerId:"3424214234",amount:56660,currency:"BDT",redirectUrl:"http://localhost:3000/dashboard",callbackUrl:"https://admin.eassypay.com/bkash_api"},{ withCredentials: true });
